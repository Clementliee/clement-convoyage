...
export const CASES: MissionCase[] = [
  ...
  },
  {
    ...
    from: "Quimper",
    to: "Rennes",
    title: "BMW Série 3 — accompagnement d’achat à Rennes",
    lead: "Le client se rendait chez le vendeur. Nous l’avons rejoint pour le contrôle visuel et le retour de l’ancien véhicule.",
    story:
      "Le client a roulé dans son véhicule actuel. Nous l’avons rejoint chez le vendeur à Rennes. Contrôle visuel de la Série 3 : carrosserie, compteur, habitacle, documents, photographies. Il a repris la route au volant de l’achat. Nous avons ramené l’ancien véhicule à Quimper.",
    beats: [
      "Rendez-vous chez le vendeur à Rennes",
      "Contrôle visuel de la Série 3, photographies",
      "Le client repart au volant de l’achat",
      "Retour de l’ancien véhicule à Quimper",
    ],
