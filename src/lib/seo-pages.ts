...
function ville(
  ...
  return {
    ...
    description: `Convoyage de véhicule à ${name}. Prise en charge, transfert sécurisé, remise protocolaire. Base Quimper. Mise en main offerte. Devis immédiat, à signer en ligne.`,
    kind: "ville",
    image: IMG,
    locality: name,
    country: "FR",
    ...
    body: [
      ...
      "Le simulateur prépare un devis immédiat après vos coordonnées. Packs particuliers et professionnels. Devis en une minute, à signer.",
...
export const SEO_PAGES: SeoPage[] = [
  ...
  ville("convoyage-angers", "Angers", "Angers relie l’ouest au Val de Loire. Livraisons mandataires et particuliers.", "Mission France type. Devis en une minute, à signer en ligne.", [
    { to: "/convoyage-nantes", label: "Nantes" },
  ...
  ]),
  {
    ...
    description: "Livraison de voitures dans toute la Bretagne. Prise en charge locale ou hors région, remise chez le client. Finistère, Morbihan, Côtes-d’Armor, Ille-et-Vilaine. Devis immédiat, à signer en ligne.",
    kind: "region",
    image: IMG,
    locality: "Bretagne",
    country: "FR",
  ...
  },
  {
    ...
    description: "Convoyage Finistère : Quimper, Brest, Concarneau, Bénodet, Douarnenez, Pont-l'Abbé, Morlaix. Devis immédiat, à signer en ligne.",
    kind: "region",
    image: IMG,
    locality: "Finistère",
    country: "FR",
  ...
  },
  {
    ...
    description: "Livraison de véhicules partout en France métropolitaine depuis Quimper. Paris, Lyon, Bordeaux, Marseille, Nice, Lille, Strasbourg. Devis immédiat, à signer en ligne.",
    kind: "france",
    image: EU,
    country: "FR",
  ...
  },
  {
    ...
    description: "Convoyage automobile, base Quimper. Prise en charge partout en France et en Europe, remise chez le client. Photos du véhicule, devis immédiat, à signer en ligne.",
    kind: "metier",
    image: IMG,
    locality: SITE.city,
    country: "FR",
    ...
    body: [
      ...
      "Ce n’est pas un transport plateau. Ce n’est pas un taxi. C’est une remise. Le prix n’est pas publié. Le simulateur prépare un devis immédiat après vos coordonnées.",
    ],
    nearby: [
