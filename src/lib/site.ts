...
export const SERVICES = [
  {
    ...
    title: "Voiturier gares et aéroports",
    text: "Prise en charge au dépose-minute, gare de Quimper, aéroports de Brest-Bretagne et Lorient. Restitution sur le parvis.",
  ...
  },
  {
    ...
    title: "Convoyage national",
    text: "Transfert routier VL, berlines, électriques, utilitaires jusqu’à 3,5 t. État des lieux numérique, assurance dédiée.",
